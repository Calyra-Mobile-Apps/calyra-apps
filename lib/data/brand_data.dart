...
final List<BrandInfo> featuredBrands = [
  const BrandInfo(
    id: 'BRD001',
    name: 'Wardah',
    imageUrl: 'assets/images/homew.png',
  ...
  const BrandInfo(
    id: 'BRD002',
    name: 'Emina',
    imageUrl: 'assets/images/homee.png',
  ...
  const BrandInfo(
    id: 'BRD007',
    name: 'Make Over',
    imageUrl: 'assets/images/homem.png',
  ...
  const BrandInfo(
    id: 'BRD006',
    name: 'Somethinc',
    imageUrl: 'assets/images/homes.png',
  ...
  const BrandInfo(
    id: 'BRD005',
    name: 'OMG Beauty',
    imageUrl: 'assets/images/homeo.png',
  ...
  const BrandInfo(
    id: 'BRD003',
    name: 'Luxcrime',
    imageUrl: 'assets/images/homel.png',
